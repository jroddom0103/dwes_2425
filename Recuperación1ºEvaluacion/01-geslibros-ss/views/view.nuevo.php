            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="autor_id">
                    ...
                    <?php foreach ($stmt_autores as $indice => $autor): ?>
                        <option value="<?= $indice ?>"><?= $autor ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="editorial_id">
                    ...
                    <?php foreach ($stmt_editoriales as $indice => $editorial): ?>
                        <option value="<?= $indice ?>"><?= $editorial ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
                ...
                <div class="form-control">
                    ...
                    <?php foreach ($stmt_generos as $indice => $genero): ?>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="<?=$indice?>" id="flexCheckDefault" name="generos_id[]">
