        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?= URL ?>album/create" method="POST">
                    ...
                    <!-- Categoria -->
                    <!-- Tiene que mostrar todos los nombres de las categorias -->
                    <div class="mb-3">
                        <label for="categoria" class="form-label">Categoria</label>
                        <select class="form-select 
                            <?= (isset($this->error['categoria'])) ? 'is-invalid' : null ?>" id="categoria"
                            ...
                            <?php foreach ($this->categorias as $indice => $data): ?>
                                <option value="<?= $data ?>" <?= $this->album->categoria == $data ? 'selected' : '' ?>>
                                    <?= $data ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
