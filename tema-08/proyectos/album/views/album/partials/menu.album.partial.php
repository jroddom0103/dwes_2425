            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/3/<?= $_SESSION['csrf_token']?>">Descripción</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/4/<?= $_SESSION['csrf_token']?>">Autor</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/5/<?= $_SESSION['csrf_token']?>">Fecha</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/6/<?= $_SESSION['csrf_token']?>">Lugar</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/7/<?= $_SESSION['csrf_token']?>">Categoría</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/8/<?= $_SESSION['csrf_token']?>">Etiquetas</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/9/<?= $_SESSION['csrf_token']?>">Nº fotos</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/10/<?= $_SESSION['csrf_token']?>">Nº visitas</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>album/ordenar/11/<?= $_SESSION['csrf_token']?>">Carpeta</a></li>
