    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table">
                    ...
                    <?php foreach ($array_profesores as $indice => $profesor): ?>
                        <tr class="align-middle">
                            ...
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <a href="eliminar.php?indice=<?=$indice ?>" title="Eliminar" class="btn btn-danger" onclick="return confirm('Confirmar eliminación del profesor')"><i class="bi bi-trash-fill"></i></a>
                ...
                <tfoot>
                    <tr><td colspan="6">Nº Registros <?= count($array_profesores) ?></td></tr>
                </tfoot>
            </table>
        </div>
    </div>
