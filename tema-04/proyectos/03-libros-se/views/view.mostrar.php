    ...
    <div class="container">
        ...
        <form>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="precio" value="<?= $libro->precio ?>" step="0.01"
                    disabled>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="materia" value="<?= $materias[$libro->materia] ?>"
                    disabled>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="etiquetas" value="<?= implode(', ', $obj_tabla_libros->mostrar_nombre_etiquetas($libro->etiquetas)) ?>"
                    disabled>
            </div>
