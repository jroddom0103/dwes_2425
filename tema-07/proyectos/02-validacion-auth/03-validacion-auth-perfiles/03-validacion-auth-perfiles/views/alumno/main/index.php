                                    ...
                                    <td>
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            <a href="<?= URL ?>alumno/eliminar/<?= $alumno->id ?>/<?= $_SESSION['csrf_token'] ?>" title="Eliminar"
                                                class="btn btn-danger <?=!in_array($_SESSION['role_id'],$GLOBALS['alumno']['eliminar'])? 'disabled':null?>"
                                            ...
                                            <a href="<?= URL ?>alumno/editar/<?= $alumno->id ?>/<?= $_SESSION['csrf_token'] ?>" title="Editar"
                                                class="btn btn-primary <?=!in_array($_SESSION['role_id'],$GLOBALS['alumno']['editar'])? 'disabled':null?>"><i class="bi bi-pencil-square"></i></a>
                                            <a href="<?= URL ?>alumno/mostrar/<?= $alumno->id ?>/<?= $_SESSION['csrf_token'] ?>" title="Mostrar"
                                                class="btn btn-warning <?=!in_array($_SESSION['role_id'],$GLOBALS['alumno']['mostrar'])? 'disabled':null?>"><i class="bi bi-eye-fill"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
