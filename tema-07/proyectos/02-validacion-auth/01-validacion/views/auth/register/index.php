    ...
    <div class="container">
        ...
        <div class="card-body">
            <form method="POST" action="<?= URL ?>auth/validate_register">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-6">
                        <input id="email" type="email"
                            ...
                            name="email" value="<?= htmlspecialchars($this->email); ?>" required autocomplete="email"
                            autofocus>
                        <!-- control de errores -->
                        <span class="form-text text-danger" role="alert">
                            <?= $this->error['email'] ??= '' ?>
                ...
                <div class="mb-3 row">
                    <label for="password_confirm" class="col-md-4 col-form-label text-md-right">Confirmar
                        password</label>
                ...
                <div class="mb-3 row mb-0">
                    <div class="col-md-8 offset-md-4">
                        ...
                        <button type="submit" formaction="<?= URL ?>register/validate"
