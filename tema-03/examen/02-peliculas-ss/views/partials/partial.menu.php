            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="order.php?criterio=nombre">Título</a></li>
                        <li><a class="dropdown-item" href="order.php?criterio=poblacion">País</a></li>
                        <li><a class="dropdown-item" href="order.php?criterio=curso">Director</a></li>
                    </ul>
                </li>
