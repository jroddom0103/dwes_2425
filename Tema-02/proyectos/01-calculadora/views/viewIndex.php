  ...
  <div class="container">
    ...
    <form method="GET">
      ...
      <div class="btn-group" role="group">
        ...
        <button type="submit" class="btn btn-warning" formaction="resta.php">Resta</button>
        <button type="submit" class="btn btn-warning" formaction="producto.php">Producto</button>
        <button type="submit" class="btn btn-warning" formaction="division.php">División</button>
        <button type="submit" class="btn btn-warning" formaction="potencia.php">Potencia</button>
      </div>
